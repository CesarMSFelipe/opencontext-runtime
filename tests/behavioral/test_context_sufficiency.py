...
class TestMemoryContract:
    ...
    def test_failure_boost_increases_after_recording(self):
        ...
        from opencontext_core.models.agent_memory import MemoryRecord, MemoryLayer, DecayPolicy
...
class TestScoringContract:
    ...
    def test_required_candidate_scores_higher(self):
        ...
        base_params = dict(
            candidate_id="c1", candidate_source="file.py",
            candidate_source_type="file", candidate_source_trust=0.8,
            candidate_modified_at=None, candidate_tokens=500,
            lexical_score=0.5, memory_boost_map={}, graph_distance_map={},
            is_test=False,
        )
    ...
    def test_memory_boosted_candidate_scores_higher(self):
        ...
        base_params = dict(
            ...
            candidate_source_type="file", candidate_source_trust=0.8,
            candidate_modified_at=None, candidate_tokens=500,
            lexical_score=0.5, graph_distance_map={}, is_required=False, is_test=False,
        )
...
class TestGatesContract:
    ...
    def test_approval_gate_fails_without_approval(self):
        """ApprovalRequiredForWritesGate must FAIL in strict mode without approval."""
